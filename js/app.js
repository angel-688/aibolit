 ...
 */
    ...
    (() => {
        ...
        if (inputMask) modules_flsModules.inputMask = Inputmask(options).mask(inputMask);
                ...
                on: {
                    init: function() {
                        ...
                        pagination.forEach(((el, index) => {
                            ...
                            el.insertAdjacentHTML("beforeend", `<svg fill="none" xmlns="http://www.w3.org/2000/svg">\n                     <circle cx="20" cy="20" r="19"/>\n                     <circle cx="20" cy="20" r="19"/>\n                     </svg>`);
                        }));
                    }
                }
            });
